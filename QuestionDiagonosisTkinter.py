...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Swatik barik", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
...
root.title("")  # Remove chatbot name
...
bg_image = PhotoImage(file=r"C:/Users/2003s/Downloads/di9rk5KAT.jpg")  # Use raw string or forward slashes
bg_label = Label(root, image=bg_image)
bg_label.place(relwidth=1, relheight=1)  # Stretch background to fit window

# Add a Medikit Icon
medikit_icon = PhotoImage(file=r"C:/Users/2003s/Downloads/1512394074.png")  # Use raw string or forward slashes
medikit_label = Label(root, image=medikit_icon)
medikit_label.pack(pady=10)

# OR: Add a clickable Medikit Button
medikit_button = Button(root, image=medikit_icon, command=lambda: print("Medikit clicked!"))
medikit_button.pack(pady=10)
